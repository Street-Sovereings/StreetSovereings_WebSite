...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Street Sovereings</title>
        <link rel="stylesheet" href="/css/app.css">
    </head>
    <body>
        <div class="navbar">
            <a href="/">
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 218 245" fill="none">
                ...
                <path d="M33.5161 197.5H183.981H187H33.5161ZM33.5161 197.5H31" stroke="#E6DDCC" stroke-width="10"/>
        ...
        <div class="box-container">
            <h3>Latest News</h3>
            <div class="box-mini-container">
                <h3 style="color:black;">Now. WebSite has been remaded on Laravel PHP</h3>
            </div>
        </div>
        <div class="box-container">
            <h3>Oldest News</h3>
            <div class="box-mini-container">
                <h3 style="color:black;">Game Source Code Published To Github</h3>
            </div>
        </div>
        </div>
    </body>
